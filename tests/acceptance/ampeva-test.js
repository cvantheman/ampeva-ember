...
module('Acceptance | ampeva', function(hooks) {
  ...
  test('visiting /, validating text', async function(assert) {
    ...
    assert.equal(whoAreWe[0].textContent, newLine4Spaces);
    assert.equal(whoAreWe[1].textContent, emptyString);
    assert.equal(whoAreWe[2].textContent, newLine4Spaces);
    assert.equal(whoAreWe[3].textContent, 'Who are we?');
    assert.equal(whoAreWe[4].textContent, newLine4Spaces);
    ...
    assert.equal(firstSectionWhatWeDoList[0].textContent, newLine8Spaces);
    ...
    assert.equal(firstSectionWhatWeDoList[2].textContent, newLine8Spaces);
    ...
    assert.equal(firstSectionWhatWeDoList[4].textContent, newLine8Spaces);
    ...
    // (40)
    assert.equal(firstSectionWhatWeDoList[6].textContent, newLine8Spaces);
    ...
    assert.equal(firstSectionWhatWeDoList[8].textContent, newLine4Spaces);
    assert.equal(firstSectionWhatWeDo[4].textContent, newLineNoSpaces);

    const secondSectionWhatWeDo = whatWeDo[2].childNodes[0].childNodes;
    // console.log('secondSectionWhatWeDo:', secondSectionWhatWeDo);
    assert.equal(secondSectionWhatWeDo.length, 3);
    assert.equal(secondSectionWhatWeDo[0].textContent, newLine4Spaces);

    const secondSectionWhatWeDoList = secondSectionWhatWeDo[1].childNodes;
    assert.equal(secondSectionWhatWeDoList.length, 15);
    assert.equal(secondSectionWhatWeDoList[0].textContent, newLine8Spaces);
    ...
    assert.equal(secondSectionWhatWeDoList[2].textContent, newLine8Spaces);
    // (50)
    ...
    assert.equal(secondSectionWhatWeDoList[4].textContent, newLine8Spaces);
    ...
    assert.equal(secondSectionWhatWeDoList[6].textContent, newLine8Spaces);
    ...
    assert.equal(secondSectionWhatWeDoList[8].textContent, newLine8Spaces);
    ...
    assert.equal(secondSectionWhatWeDoList[10].textContent, newLine8Spaces);
    ...
    assert.equal(secondSectionWhatWeDoList[12].textContent, newLine8Spaces);
    // (60)
    ...
    assert.equal(secondSectionWhatWeDoList[14].textContent, newLine4Spaces);
    assert.equal(secondSectionWhatWeDo[2].textContent, newLineNoSpaces);
    assert.equal(whatWeDo[3].textContent, '    ');
  });
});
